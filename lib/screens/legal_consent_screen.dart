...
import '../theme/legal_consent_screen_tokens.dart';
...
class _LegalConsentScreenState extends State<LegalConsentScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      data: LegalConsentScreenUi.overlayTheme(theme),
      child: Scaffold(
        backgroundColor: LegalConsentScreenUi.canvas,
        body: SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                CheckboxListTile(
                  ...
                  activeColor: LegalConsentScreenUi.primary,
                  title: Text(
