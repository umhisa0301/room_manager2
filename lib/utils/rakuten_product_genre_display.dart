...
/// 4. ローカル定数マスタ → ランタイムキャッシュ → 同梱 JSON マスタ（[RakutenGenreMasterService.genreNameIfKnown]）
/// 5. いずれでも解決できない、または [genreId] が空のときは
///    [RakutenGenreMasterService.unknownGenreDisplayLabel]（未分類）
